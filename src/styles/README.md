...
Stylesheets are imported in their original cascade order by `app.css`, loaded from `src/main.ts` and bundled by Vite.
...
- Image URLs in page stylesheets are relative to `pages/`, for example `../../../public/assets/images/heroes/frames/bg-ssr.webp`.
- Add a new stylesheet to `app.css` when introducing a new page-specific file.
